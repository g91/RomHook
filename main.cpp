...
{
	Nexus::BC2::Base::GetInstance()->InitHooks((bool)pIsServer);
}
...
void Main_DoInit()
{
	...
	DWORD sVerAddr = Nexus::BC2::Base::CheckVersion();
	Nexus::OnlineCheck::CheckStatus();
	if (sVerAddr > 0)
