...
BOOL CFileVersionInfo::Open( IN char* lpszFileName )
{
...
char* CFileVersionInfo::GetOtherProductVersion()
{
	::ZeroMemory( g_charTmp, sizeof( g_charTmp ) );

	QueryStringValue( s_ppszStr[ VI_STR_FILEVERSION ], g_charTmp, 128 );
