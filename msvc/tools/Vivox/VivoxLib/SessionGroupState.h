...
public:
    ...
    void UpdateSession(std::string session_handle, int tx, int focus, int muted, int textmuted, int font_id, int vol);
    void UpdateMediaState(std::string session_handle, vx_session_media_state state);
    void UpdateTextState(std::string session_handle, vx_session_text_state state);
